...
class Application_Form_Incidenciadet extends Twitter_Form {
    ...
    public function init() {
        ...
        $tipo->setLabel('Estado:')
                ->setMultiOptions(array('Cierre' => 'Cerrar incidencia', 'Reasignacion' => 'Reasignar incidencia', 'Abierta en Proveedor' => 'Actualizar estado incidencia a abierta en Proveedor', 'Abierta en Centro' => 'Actualizar estado incidencia a abierta en Centro', 'Cambioestadoequipo' => 'Actualizar estado equipo') )
                ->setAttribs(array('maxlength' => '50', 'class' => 'span12 combobox', 'data-provide' => 'typeahead', 'data-items' => 4,
                    'data-source' => '["Cerrar incidencia", "Reasignar incidencia", "Actualizar estado incidencia a abierta en Proveedor", "Actualizar estado incidencia a abierta en Centro", "Actualizar estado equipo"]'));
        /* ->setValue('Zaragoza'); */
