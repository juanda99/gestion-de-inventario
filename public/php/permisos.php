...
$aColumns = array( 'perfil', 'nombre', 'descripcion', 'regla_id', 'acl_id', 'perfil_id');
...
/* Añadimos los datos por defecto */
if ($sWhere == "") {
    $sWhere = "WHERE visible=1 and perfil!='Administrador'";
} else {
    $sWhere .= " and visible=1 and perfil!='Administrador'";
}
...
$sQuery = "
		...
		FROM   $sTable
                WHERE visible=1 and perfil!='Administrador'
	";
