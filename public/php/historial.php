...
$aColumns = array('id_incidencia', 'tipo', 'fecha_incidencia', 'causa', 'responsable');
...
if (isset($_GET['id_inventario'])) {
    $id_inventario = mysql_real_escape_string($_GET['id_inventario']);
    if ($sWhere == "") {
        $sWhere = "WHERE inventario_id_inventario='" . $id_inventario . "'";
    } else {
        $sWhere .= " AND inventario_id_inventario='" . $id_inventario . "'";
    }
}
