<?php
	...
	$aColumns = array( 'proveedor', 'codigo',  'material', 'departamentos', 'id_proveedor', 'descripcion', 'telefono', 'movil', 'fax',
        'nif', 'email', 'direccion', 'localidad', 'provincia', 'cp', 'id_departamento' );
