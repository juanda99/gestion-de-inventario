...
jQuery.validator.addMethod("greaterThan", function(value, element, params) {
    ...
    {
        /*Convertimos el primero en yyyymmdd*/
        var datePart = value.match(/\d+/g);
        var year = datePart[2];//.substring(2), // get only two digits
        var month = datePart[1];
        var day = datePart[0];
        var fecha = year + month+ day;
        /*Convertimos el segundo en yyyymmdd*/
        var fecha2 = ($(params).val());
        datePart = fecha2.match(/\d+/g);
